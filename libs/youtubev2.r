...
0.#Replace device names to franch versions
...
#Rename
setnames(DT, c("Account","Campaign","Device","Clicks","Cost","Views","Taux","Year"), c("Compte","Campagne","Appareil","Clics","Coût","Affichage","Taux de visionnage","Année"))
setcolorder(DT, c("Compte","Année","Appareil","Campagne","Clics","Impressions","Coût","Affichage","Taux de visionnage"))